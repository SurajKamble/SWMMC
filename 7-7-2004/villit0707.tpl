...
;;-------------- ---------- ----------
VillIT           IT
VillIT           SURFACE    0.0        0.0        #srf_rghns#      0.0        5         
VillIT           STORAGE    72         #str_vdrto#       #str_hdcnd#         #str_clgfr#       
VillIT           DRAIN      #drn_flwco#          #drn_fwexp#        0.0       6         

[LID_USAGE]
;;Subcatchment   LID Process      Number  Area       Width      InitSat    FromImp    ToPerv     RptFile                  DrainTo         
;;-------------- ---------------- ------- ---------- ---------- ---------- ---------- ---------- ------------------------ ----------------
LID              VillIT           1       125.89     #srf_width#       #  int_sat#         100        0          ".\LIDReport.txt"
