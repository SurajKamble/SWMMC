...
;;-------------- ---------------- ---------------- -------- -------- -------- -------- -------- ----------------
Roadway          01-11-2006_Storm   LID              0.224    100      #rd_width#     #rd_slope#        0                        
;Swale
...
;;-------------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
Roadway          #rd_rghns#       0.24       1          5          100        OUTLET    
LID              0.01       0.24       0.05       #dprsn_strg#    100        OUTLET    

[INFILTRATION]
;;Subcatchment   Suction    Ksat       IMD       
;;-------------- ---------- ---------- ----------
Roadway          99.441     7.112      0.378     
LID              #sctn_hd# #hyd_cndct # #ntl_dfct#     

[LID_CONTROLS]
;;Name           Type/Layer Parameters
;;-------------- ---------- ----------
Swale            VS
Swale            SURFACE    #strg_dpth# #vgttn_vlm# #srf_rghns# #srf_slope# #sid_slope#     

[LID_USAGE]
;;Subcatchment   LID Process      Number  Area       Width      InitSat    FromImp    ToPerv     RptFile                  DrainTo         
;;-------------- ---------------- ------- ---------- ---------- ---------- ---------- ---------- ------------------------ ----------------
LID              Swale            1       3120       15.76      #int_sat#          100        0          ".\UMD0111.txt"
