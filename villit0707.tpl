...
;;-------------- ---------- ----------
VillIT           IT
VillIT           SURFACE    0.0        0.0        #srf_rghns#      #qew#        5         
VillIT           STORAGE    #erw#         #str_vdrto#       #str_hdcnd#         #str_clgfr#       
VillIT           DRAIN      #drn_flwco#          #drn_fwexp#        #sff#       6         

[LID_USAGE]
;;Subcatchment   LID Process      Number  Area       Width      InitSat    FromImp    ToPerv     RptFile                  DrainTo         
;;-------------- ---------------- ------- ---------- ---------- ---------- ---------- ---------- ------------------------ ----------------
LID              VillIT           1       125.89     #srf_width#       #int_sat#         #sss#        0          ".\LIDReport.txt"
